defmodule Day9 do
  ...
  @doc """
  iex> Day9.part1([35, 20, 15, 25, 47, 40, 62, 55, 65, 95, 102, 117, 150, 182,
  ...
  @doc """
  iex> Day9.part2([35, 20, 15, 25, 47, 40, 62, 55, 65, 95, 102, 117, 150, 182,
  ...>             127, 219, 299, 277, 309, 576], 5)
  {[15, 25, 47, 40], 62}
  """
  ...
  def part1_verify do
    Advent.data(9) |> parse_input |> part1(25)
  end

  def part2_verify do
    Advent.data(9) |> parse_input |> part2(25)
  end
end
