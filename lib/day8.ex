defmodule Day8 do
  ...
  @doc """
  iex> Day8.part1(%{0 => {:noop, 0}, 1 => {:acc, 1}, 2 => {:jmp, 4}, 3 => {:acc, 3}, 4 => {:jmp, -3},
  ...
  @doc """
  iex> Day8.part2(%{0 => {:noop, 0}, 1 => {:acc, 1}, 2 => {:jmp, 4}, 3 => {:acc, 3}, 4 => {:jmp, -3},
  ...>              5 => {:acc, -99}, 6 => {:acc, 1}, 7 => {:jmp, -4}, 8 => {:acc, 6}})
  {:exit, 8}
  """
  def part2(input) do
  ...
  def part1_verify do
    Advent.data(8) |> parse_input |> part1
  end

  def part2_verify do
    Advent.data(8) |> parse_input |> part2
  end
end
