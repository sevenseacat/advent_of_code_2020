defmodule Day7 do
  ...
  @doc """
  iex> Day7.parse_input("light red bags contain 1 bright white bag, 2 muted yellow bags.
  ...
  def part1_verify do
    Advent.data(7) |> parse_input |> part1()
  end

  def part2_verify do
    Advent.data(7) |> parse_input |> part2
  end
end
