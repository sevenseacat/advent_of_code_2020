defmodule Day4 do
  ...
  @doc """
  iex> Day4.valid_fields?(%{iyr: 2013, ecl: "amb", cid: 350, eyr: 2023, pid: "028048884", hcl: "#cfa07d", byr: 1929})
  false

  iex> Day4.valid_fields?(%{hcl: "#ae17e1", iyr: 2013, eyr: 2024, ecl: "brn", pid: "760753108", byr: 1931, hgt: 179})
  true
  """
  ...
  @doc """
  iex> Day4.valid_values?(%{byr: 2002})
  true

  iex> Day4.valid_values?(%{byr: 2003})
  false

  iex> Day4.valid_values?(%{hgt: "60in"})
  true

  iex> Day4.valid_values?(%{hgt: "190cm"})
  true

  iex> Day4.valid_values?(%{hgt: "190in"})
  false

  iex> Day4.valid_values?(%{hgt: "190"})
  false

  iex> Day4.valid_values?(%{hcl: "#123abc"})
  true

  iex> Day4.valid_values?(%{hcl: "#123abz"})
  false

  iex> Day4.valid_values?(%{hcl: "123abc"})
  false

  iex> Day4.valid_values?(%{ecl: "brn"})
  true

  iex> Day4.valid_values?(%{ecl: "wat"})
  false

  iex> Day4.valid_values?(%{pid: "000000001"})
  true

  iex> Day4.valid_values?(%{pid: "0123456789"})
  false
  """
  ...
  @doc """
  iex> Day4.parse_input("iyr:2013 ecl:amb cid:350 eyr:2023 pid:028048884
  ...>hcl:#cfa07d byr:1929
  ...>
  ...>hcl:#ae17e1 iyr:2013
  ...>eyr:2024
  ...
  def part1_verify do
    Advent.data(4) |> parse_input |> part1()
  end

  def part2_verify do
    Advent.data(4) |> parse_input |> part2()
  end
end
