defmodule Day2 do
  ...
  @doc """
  iex> Day2.valid_old_password?(%{min: 1, max: 3, letter: "a", password: "abcde"})
  true

  iex> Day2.valid_old_password?(%{min: 1, max: 2, letter: "b", password: "cdefg"})
  false
  """
  ...
  @doc """
  iex> Day2.valid_new_password?(%{min: 1, max: 3, letter: "a", password: "abcde"})
  true

  iex> Day2.valid_new_password?(%{min: 2, max: 9, letter: "c", password: "ccccccccc"})
  false
  """
  ...
  @doc """
  iex> Day2.parse_input("1-3 a: abcde\\n2-7 b: cdefg")
  ...
  def part1_verify do
    Advent.data(2) |> Day2.parse_input() |> Day2.part1()
  end

  def part2_verify do
    Advent.data(2) |> Day2.parse_input() |> Day2.part2()
  end
end
